  ...
  <div class="container mx-auto h-full lg:h-screen">
    <div class="lg:calc-h-full-20">
      <div class="lg:h-20 flex flex-col justify-center items-center">
        ...
        <h2
          class="text-center font-medium text-base lg:text-lg text-gray-700 mt-2 dark:text-gray-100"
        >
      ...
      >
        ...
        <div
          class="flex flex-row lg:flex-col lg:gap-y-8 lg:justify-between w-full lg:w-1/5 animate__animated animate__bounceInDown"
        >
          <div class="h-3/5 mx-3 lg:mx-0">
