<template>
  <div class="container mx-auto h-full md:h-screen">
    <div class="md:calc-h-full-20">
      ...
      <div
        class="flex flex-col gap-y-6 md:gap-y-0 md:flex-row md:gap-x-8 w-full calc-h-full-40 mt-4"
      >
        <div
        ...
        >
          ...
          <div class="md:h-2/5 hidden md:flex">
        ...
        >
          <div class="h-2/5 hidden md:flex">
